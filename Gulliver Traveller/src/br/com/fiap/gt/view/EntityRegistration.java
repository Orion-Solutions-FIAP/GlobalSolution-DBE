...
import br.com.fiap.gt.bean.Day;
...
public class EntityRegistration {
	...
	public static void main(String[] args) {
		...
		RentalCompany rentalCompany = new RentalCompany("Localiza",
				...
				"-23.546838",
				"Localiza Rent a Car, conhecida apenas como Localiza, é uma rede brasileira de lojas especializadas em aluguel de carros",
				"https://www.localiza.com/brasil/pt-br");

		// Adicionando horários da locadora de carro
		...
		// Adicionando a avaliação à locadora
